...
--
-- TOC entry 852 (class 1247 OID 24629)
...
--
-- TOC entry 217 (class 1259 OID 24635)
-- Name: Clothes; Type: TABLE; Schema: public; Owner: postgres
--

CREATE TABLE public."Clothes" (
    user_id bigint NOT NULL,
    clothes_id bigint DEFAULT nextval('public.clothes_id_seq'::regclass) NOT NULL,
...
CREATE TABLE public."TryonResults" (
    user_id bigint NOT NULL,
    try_on_id bigint DEFAULT nextval('public.clothes_id_seq'::regclass) NOT NULL,
    top_id bigint,
    bottom_id bigint,
...
--
-- TOC entry 3576 (class 2604 OID 24656)
...
--
-- TOC entry 3739 (class 0 OID 24635)
-- Dependencies: 217
...
--
-- TOC entry 3740 (class 0 OID 24641)
-- Dependencies: 218
...
--
-- TOC entry 3744 (class 0 OID 24651)
-- Dependencies: 222
...
--
-- TOC entry 3742 (class 0 OID 24647)
-- Dependencies: 220
...
SELECT pg_catalog.setval('public.clothes_id_seq', 45, true);
...
--
-- TOC entry 3579 (class 2606 OID 24690)
-- Name: Clothes Clothes_pkey; Type: CONSTRAINT; Schema: public; Owner: postgres
--

ALTER TABLE ONLY public."Clothes"
    ADD CONSTRAINT "Clothes_pkey" PRIMARY KEY (user_id, clothes_id);


--
-- TOC entry 3585 (class 2606 OID 24660)
...
--
-- TOC entry 3581 (class 2606 OID 24662)
...
--
-- TOC entry 3589 (class 2606 OID 24664)
...
--
-- TOC entry 3587 (class 2606 OID 24666)
...
--
-- TOC entry 3582 (class 1259 OID 24704)
...
--
-- TOC entry 3583 (class 1259 OID 24698)
...
--
-- TOC entry 3590 (class 2606 OID 24667)
...
--
-- TOC entry 3591 (class 2606 OID 24710)
...
--
-- TOC entry 3592 (class 2606 OID 24705)
...
--
-- TOC entry 3593 (class 2606 OID 24682)
